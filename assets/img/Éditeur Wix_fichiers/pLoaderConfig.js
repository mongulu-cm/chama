function getPloaderSantaConfig(serviceTopology, baseVersion, PackagesUtil) {
    ...
    var packages = ["animations","cloud","components","componentsPreviewLayer","core","documentServices","editingRendererPlugins","fonts","imageClientApi","layout","previewExtensionsCore","qaAutomation","render","server","skins","testUtils","tpa","tweenEngine","utils","widgets","wixCode","wixSites","wixappsBuilder","wixappsClassics","wixappsCore"];
    /* global joinURL */
